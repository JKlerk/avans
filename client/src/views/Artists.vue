		...
		<div class="flex justify-center pt-5 pb-10">
			<div class="mx-20 w-2/3">
				...
				<div class="flex flex-wrap mt-10">
					<div class="flex shadow rounded-lg bg-white w-1/2 hover:opacity-50 transition duration-200 cursor-pointer mb-5" :key="artist.id" v-for="artist in getArtists()" @click="$refs.editartist.visible = true, $refs.editartist.artist = artist">
